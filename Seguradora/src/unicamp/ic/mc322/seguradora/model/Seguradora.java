...
public class Seguradora extends Model {
	...
	public ArrayList<Cliente> listarClientes(Predicate<String> condicao) {
		ArrayList<Cliente> lista = new ArrayList<>();
		for (Cliente c : listaCliente) {
			if (condicao.test(c.getCodigoPessoa()))
				lista.add(c);
		}
		return lista;
	}
	...
	public ArrayList<Seguro> listarSegurosPorCliente(String codigoClienteString) {
		...
		for (Seguro seguroObj : listaSeguros) {
			if (seguroObj.getCliente().equals(codigoClienteString))
	...
	public ArrayList<Frota> listarFrotas() {
		ArrayList<Frota> lista = new ArrayList<>();
	...
	public Frota selecionarFrota(String codeString) {
		Frota objFrota = null;
		for (Frota f : listarFrotas()) {
			if (f.getCode().equals(codeString))
				return objFrota;
		}
		return null;
	}
