...
public class Util {
	...
	public static void basicStruture() {
		...
		Cliente objCliente1 = new ClientePF("Roberto", "Rua felix", "Masc", "07150760279",
				Util.parseLocalDate("30-01-2005"), "Superior", Util.parseLocalDate("30-01-2005"), "D", "92 9 96140802",
				"Ludivik@gmail.com");
		...
		Seguro objSeguro = new SeguroPF(Util.parseLocalDate("30-01-2005"), Util.parseLocalDate("30-01-2005"),
				objCliente1, objVeiculo1, seg);
