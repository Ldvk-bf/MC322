...
public class Input {
	...
	public static void transferirSeguro(Scanner scan, Seguradora seg) {
		...
		Cliente objCliente2 = Input.cliente.selecaoCliente(scan, seg, true, (data) -> Validar.validarCPF(objCliente1.getCodigoPessoa()) ? Validar.validarCPF(data) : Validar.validarCnpj(data));
	...
	public class cliente {
		public static String[] cadastro(Scanner scan) {
			...
			String telefoneString = Input.scanString(scan, "Telefone do CLIENTE (Não se esqueça do DDD)", (data) -> Validar.validarTelefone(data));
		...
		public static void addCliente(Scanner scan, Seguradora seg) {
			...
			String cadastroPessoaString = Input.scanString(scan, "Código de cadastro da PESSOA:", (data) -> true).replaceAll("[^0-9]+", "");
		...
		public static Cliente selecaoCliente(Scanner scan, Seguradora seg, boolean selecao, Validar.FuncaoValidador condicao) {
			String dado;
			...
			if(selecao && !seg.listarClientes(condicao).isEmpty())
				dado = Input.scanString(scan, "Digite o código de cadastro de pessoa para SELECIONAR", (data) -> Validar.validarCPF(data) || Validar.validarCnpj(data)).replaceAll("[^0-9]+", "");
			else
	...
	public class clientePJ {
		public static ClientePJ cadastro(Scanner scan, Seguradora seg, String[] novoCliente, String cadastroString) {
			 ...
			 String dataFundacaoString = Input.scanString(scan, "Data fundacao da PESSOA JURIDICA (EX. 30-01-2000):", (data) -> Validar.validarData(data));

			 String qtdeFuncionariosString = Input.scanString(scan, "Quantidade de funcionarios da PESSOA JURIDICA:", (data) -> Validar.validarNumero(data));
			 
			 return new ClientePJ(novoCliente[0], novoCliente[1], cadastroString, Util.parseLocalDate(dataFundacaoString), Integer.parseInt(qtdeFuncionariosString), novoCliente[2], novoCliente[3]);
		}
	}
	...
	public class clientePF {	
		public static ClientePF cadastro(Scanner scan, Seguradora seg, String[] novoCliente, String cadastroString) {
			//scanner.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");		 
			 ...
			 String generoString  = Input.scanString(scan, "Genero da PESSOA FÍSICA (Masc, Fem, Outro):", (data) -> Validar.validarGenero(data)); 

			 String dataLicencaLocalDate  = Input.scanString(scan, "Data de licensa da PESSOA FÍSICA (EX: 30-01-2005):", (data) -> Validar.validarData(data)); 

			 String educacaoString  = Input.scanString(scan, "Educação da PESSOA FÍSICA:", (data) -> true); 

			 String dataNascimentoLocalDate  = Input.scanString(scan, "Data de nascimento da PESSOA FÍSICA (EX: 30-01-2005):", (data) -> Validar.validarData(data)); 

			 String classeEconomicaString  = Input.scanString(scan, "Classe economica da PESSOA FÍSICA (A, B, C, D, E):", (data) -> Validar.validarClasseEconomica(data)); 
			 
			 return new ClientePF(novoCliente[0], novoCliente[1], generoString, cadastroString, Util.parseLocalDate(dataLicencaLocalDate),
					 				educacaoString, Util.parseLocalDate(dataNascimentoLocalDate), classeEconomicaString, novoCliente[2], novoCliente[3]);
		}
	}
	...
	public class veiculo {
		public static Veiculo cadastro(Scanner scan) {
			...
			String placaString  = Input.scanString(scan, "Placa do VEÍCULO (EX. AAA1A11)", (data) -> Validar.validarPlaca(data)); 
			...
			String anoFabricacaoString  = Input.scanString(scan, "Ano do VEÍCULO", (data) -> Validar.validarNumero(data)); 
		...
		public static Veiculo selecaoVeiculo(Scanner scan, Seguradora seg, boolean selecao) {
			...
			if(selecao && !seg.listarVeiculos().isEmpty())
				dado = Input.scanString(scan, "Digite o código da placa para SELECIONAR", (data) -> Validar.validarPlaca(data));
			else
				dado = Input.scanString(scan, "Digite qualquer coisa para sair", (data) -> true);
		...
		public static Veiculo selecaoVeiculoPorFrota(Scanner scan, Seguradora seg, boolean selecao, Cliente cliente, Frota frota) {
			String dado;
	...
	public class seguradora {
		public static Seguradora cadastro(Scanner scan) {
			 ...
			 String telefoneString  = Input.scanString(scan, "Telefone da SEGURADORA (Não se esqueça do DDD)", (data) -> Validar.validarTelefone(data)); 
	...
	public class seguro {
		public static String[] cadastro(Scanner scan, Seguradora seg) {
			...
			String dataInicioString = Input.scanString(scan, "Data de início do CONDUTOR (EX. 30-01-2000)", (data) -> Validar.validarData(data)); 

			String dataFimString = Input.scanString(scan, "Data de fim do CONDUTOR (EX. 30-01-2000)", (data) -> Validar.validarData(data));
	...
	public class seguroPF {
		public static SeguroPF cadastro(Scanner scan, Seguradora seg, Cliente cliente) {
			...
			return new SeguroPF(Util.parseLocalDate(resultadoObj[0]), Util.parseLocalDate(resultadoObj[1]), cliente, objVeiculo, seg);
		}
	}
	...
	public class seguroPJ {
		public static SeguroPJ cadastro(Scanner scan, Seguradora seg, Cliente cliente) {
			...
			return new SeguroPJ(Util.parseLocalDate(resultadoObj[0].toString()), Util.parseLocalDate(resultadoObj[1].toString()), cliente, objFrota, seg);
		}
	}
	...
	public class condutor {
		public static Condutor cadastro(Scanner scan) {
			...
			String cpfString = Input.scanString(scan, "Cpf do CONDUTOR", (data) -> Validar.validarCPF(data)).replaceAll("[^0-9]+", ""); 

			String nomeString = Input.scanString(scan, "Nome do CONDUTOR", (data) -> Validar.validarNome(data)); 

			String telefoneString = Input.scanString(scan, "Telefone do CONDUTOR (Não se esqueça do DDD)", (data) -> Validar.validarTelefone(data)); 
			...
			String dataNascimentoString = Input.scanString(scan, "Data nascimento do CONDUTOR:", (data) -> Validar.validarData(data)); 
			
			return new Condutor(cpfString, Util.parseLocalDate(dataNascimentoString), nomeString, enderecoString, telefoneString, emailString);
		}
		...
		public static Condutor selecaoCondutor(Scanner scan, Seguradora seg, boolean selecao) {
			...
			if(selecao && !seg.listarCondutor().isEmpty())
				dado = Input.scanString(scan, "Digite o cpf para SELECIONAR", (data) -> Validar.validarCPF(data)).replaceAll("[^0-9]+", "");
			else
				dado = Input.scanString(scan, "Digite qualquer coisa para sair", (data) -> true);
		...
		public static Condutor selecaoCondutorPorCliente(Scanner scan, Seguradora seg, boolean selecao, Cliente cliente) {
			String dado;
			...
			if(selecao && !seg.listarCondutoresPorCliente(cliente.getCodigoPessoa()).isEmpty())
				dado = Input.scanString(scan, "Digite o cpf do CONDUTOR para SELECIONAR", (data) -> Validar.validarCPF(data)).replaceAll("[^0-9]+", "");
			else
				dado = Input.scanString(scan, "Digite qualquer coisa para sair", (data) -> true);
			Print.tab("", 0);
			return seg.selecionarCondutor(dado);
	...
	public class sinistro {
		...
		public static Sinistro selecaoSinistroPorCliente(Scanner scan, Seguradora seg, boolean selecao, Cliente cliente) {
			String dado;
			...
			if(selecao && !seg.listarSinistrosPorCliente(cliente.getCodigoPessoa()).isEmpty())
				dado = Input.scanString(scan, "Digite o id do CONDUTOR para SELECIONAR", (data) -> Validar.validarNumero(data));
			else
				dado = Input.scanString(scan, "Digite qualquer coisa para sair", (data) -> true);
			Print.tab("", 0);
			return seg.selecionarSinistro(dado);
