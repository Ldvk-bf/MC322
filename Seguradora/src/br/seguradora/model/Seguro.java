...
public abstract class Seguro {
	...
	public String toString() {
		return "[class: Seguro, id: "+this.id+", cliente: "+this.getCliente()+", data de inicio: "+this.dataInicio+", data de fim: "+this.dataFim+", seguradora: "+this.seguradora+", lista de sinistros:"+this.getListaSinistros()+", lista de condutores:"+this.getListaCondutores()+" ]";
	}
